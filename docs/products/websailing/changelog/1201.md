---
title: NX 120.1
long_title: WebSailing NX 120.1
summary: WebSailing NX 120.1.8763.30595 (Hiei)
date : 2023-12-29
---
### バージョン
...
---
[ ダウンロード](https://download.wsoft.ws/WS00281){: .btn .btn-primary .btn-lg .bi .bi-download }
---

### 変更内容
- Chromiumコンポーネントを、[Chromium 120.0.6099.129](https://chromereleases.googleblog.com/2023/12/stable-channel-update-for-desktop_20.html)へ更新
- AliceScriptの実装を、[AliceSister 3.0.2312.1003](https://docs.wsoft.ws/products/alice/changelog/3-0/)へ更新

!!!warning "セキュリティ更新"
    このリリースは、重要なセキュリティ更新を含んでいます。
    これには、ゼロデイ脆弱性である[CVE-2023-7024](https://github.com/advisories/GHSA-7c6v-f3h8-2x89)に対応する修正を含みます。

!!!warning "Alice3.0と破壊的変更"
    このリリースは、AliceScriptの更新を含んでいます。
    Alice3.0への更新によって発生する破壊的変更については、[互換性に影響を与える変更点](../../alice/changelog/compatibility.md)を参照してください。
