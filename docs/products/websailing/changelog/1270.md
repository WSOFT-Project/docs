---
title: NX 127
long_title: WebSailing NX 127
summary: WebSailing NX 127.0.9004.42035 (Hiei)
date : 2024-08-26
---
### バージョン

* WebSailing NX 127.0.9004.42035 (Hiei)
...
---
[ ダウンロード](https://download.wsoft.ws/WS00301){: .btn .btn-primary .btn-lg .bi .bi-download }
---

### 変更内容
- Chromiumコンポーネントを、[Chromium 127.0.6533.120](https://chromereleases.googleblog.com/2024/08/stable-channel-update-for-desktop_13.html)へ更新
- 起動時にChromiumが表示されてしまう不具合を修正
