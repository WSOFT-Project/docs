...
---
[ ダウンロード](https://download.wsoft.ws/WS00180){: .btn .btn-primary .btn-lg .bi .bi-download }
---

### 変更内容

* AliceScriptコンポーネントを、[AliceSister 2.2.1](https://github.com/WSOFT-Project/Losetta/releases/tag/0.9.19)へ更新
