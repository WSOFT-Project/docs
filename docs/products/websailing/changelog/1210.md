---
title: NX 121
long_title: WebSailing NX 121
summary: WebSailing NX 121.0.8806.24961 (Hiei)
date : 2024-02-10
---
### バージョン

* WebSailing NX 121.0.8806.24961 (Hiei)
* WSPlugin 1.1.8722.38740
* CEF r121.3.7+g82c7c57+chromium-121.0.6167.160
...
---
[ ダウンロード](https://download.wsoft.ws/WS00287){: .btn .btn-primary .btn-lg .bi .bi-download }
---

### 変更内容
- ユーザー設定や拡張機能、Cookieのリセット機能を実装
- 「回復」ウインドウからバックアップを使って修復できるように
- Chromiumコンポーネントを、[Chromium 121.0.6167.160](https://chromereleases.googleblog.com/2024/02/stable-channel-update-for-desktop.html)へ更新
