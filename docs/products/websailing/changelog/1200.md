---
title: NX 120
long_title: WebSailing NX 120
summary: WebSailing NX 120.0.8752.39861 (Hiei)
date : 2023-12-18
---
### バージョン

* WebSailing NX 120.0.8752.39861 (Hiei)
* WSPlugin 1.1.8722.38740
* CEF r120.1.8+ge6b45b0+chromium-120.0.6099.109
...
---
[ ダウンロード](https://download.wsoft.ws/WS00279){: .btn .btn-primary .btn-lg .bi .bi-download }
---

### 変更内容
- 起動時に自動的に更新を確認する機能を実装
- 設定ページのレンダリングに時間がかかるとき、メッセージを表示するように改善
- バックアップ機能が正しく動作しない問題を修正
- Chromiumコンポーネントを、[Chromium 120.0.6099.109](https://chromereleases.googleblog.com/2023/12/stable-channel-update-for-desktop_12.html)へ更新
- Chromiumコンポーネントを、[Chromium 120.0.6099.71](https://chromereleases.googleblog.com/2023/12/stable-channel-update-for-desktop_6.html)へ更新
