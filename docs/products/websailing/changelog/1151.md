---
title: NX 115.1
long_title: WebSailing NX 115.1
summary: WebSailing NX 115.0.8618.31581 (Hiei)
date : 2023-08-12
---
### バージョン
...
---
[ ダウンロード](https://download.wsoft.ws/WS00264){: .btn .btn-primary .btn-lg .bi .bi-download }
---

### 変更内容

* Chromiumコンポーネントを、[Chromium 115.0.5790.171](https://chromereleases.googleblog.com/2023/08/stable-channel-update-for-desktop.html)へ更新
* 設定ページのチェックボックスのUIを改善
