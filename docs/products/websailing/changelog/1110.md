---
title: NX 111
summary: WebSailingNX バージョン111の更新情報をお知らせします。
date : 2023-03-15
---
### バージョン

* WebSailing NX 111.0.8474.30497 (Hiei)
* CEF 111.2.2+g1b83ff6+chromium-111.0.5563.65
...
---
[ ダウンロード](https://download.wsoft.ws/WS00181){: .btn .btn-primary .btn-lg .bi .bi-download }
---

### 変更内容

* AliceScriptコンポーネントを、AliceSister 2.3preへ更新
* `browser`オブジェクトに`Navigating`と`Loaded`、`AddressChanged`イベントを実装
* 高DPIサポートの無効化フラグの廃止
* ダークモードが適用できない問題を修正
* オフライン時にWebSailingページを正しく表示できない不具合を修正
* WebSailingページのダークモードが設定に追従するように
* `websailing://news`で最新情報をお知らせ
