---
title: NX 117.1
long_title: WebSailing NX 117.1
summary: WebSailing NX 117.1.8684.32794 (Hiei)
date : 2023-10-11
---
### バージョン

* WebSailing NX 117.1.8684.32794 (Hiei)
* WSPlugin 1.0.8590.39572
* CEF r117.2.4+g5053a95+chromium-117.0.5938.150
...
---
[ ダウンロード](https://download.wsoft.ws/WS00274){: .btn .btn-primary .btn-lg .bi .bi-download }
---

### 変更内容
- Urlの判定基準を改善
- パフォーマンスの改善
- Chromiumコンポーネントを、[Chromium 117.0.5938.150](https://chromereleases.googleblog.com/2023/10/stable-channel-update-for-desktop.html)へ更新
- 互換性維持のために残されていた旧バージョンの設定(`websailing://oldsettings/`)を廃止
